...
table.insert(SuburbsDistributions["all"]["bin"].items, "SM.EmptyMatchbox");
table.insert(SuburbsDistributions["all"]["bin"].items, 1.0);
...
table.insert(ProceduralDistributions["list"]["JanitorMisc"].items, 0.04);
...
table.insert(ProceduralDistributions["list"]["KitchenRandom"].items, 0.05);
...
table.insert(ProceduralDistributions["list"]["StoreCounterTobacco"].items, 0.4);
...
table.insert(VehicleDistributions["GloveBox"].items, 0.04);
...
table.insert(VehicleDistributions["GloveBox"].items, 0.004);

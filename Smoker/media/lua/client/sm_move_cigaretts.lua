...
function TimedMovingCigaretessToPack(player, type_cigarettes, counter_cigarettes, item)
	local counter = counter_cigarettes * 50
...
Events.OnFillInventoryObjectContextMenu.Add(invContextMenuMenuMovingCigarettes); -- контекстное меню для заправки зажигалки
...
ISInventoryPaneContextMenu.onChangefiremode = function(playerObj, weapon, newfiremode)
	oldfiremode = weapon:getFireMode();
    ...
    if "Burst" == newfiremode then
		...
		weapon:setSwingSound('M16Shoot3')
        weapon:setMaxDamage(3*weapon:getMaxDamage());
        weapon:setMinDamage(3*weapon:getMinDamage());
        weapon:setRecoilDelay(4*weapon:getRecoilDelay());
    elseif "Burst" == oldfiremode then
        weapon:setAmmoPerShoot(1);
		weapon:setSwingSound('M16Shoot')
        weapon:setMaxDamage(0.33333*weapon:getMaxDamage());
        weapon:setMinDamage(0.33333*weapon:getMinDamage());
        weapon:setRecoilDelay(0.25*weapon:getRecoilDelay());
	end
...
ISInventoryPaneContextMenu.doMakeUpMenu = function(context, makeup, playerObj)
    ...
    if (not mirror) and (makeup:getFullType() ~= "Base.MakeupFoundation") then
        local tooltip = ISInventoryPaneContextMenu.addToolTip();
        option.notAvailable = true;

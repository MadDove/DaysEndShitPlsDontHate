...
table.insert(SuburbsDistributions["all"]["inventorymale"].items, 1);
table.insert(SuburbsDistributions["all"]["inventorymale"].items, "SWeapons.WeaponMag6");
table.insert(SuburbsDistributions["all"]["inventorymale"].items, 0.01);
...
table.insert(SuburbsDistributions["all"]["inventorymale"].items, "Base.Glasses_Eyepatch_Left");
table.insert(SuburbsDistributions["all"]["inventorymale"].items, 0.5);
table.insert(SuburbsDistributions["all"]["inventorymale"].items, "Base.Glasses_Eyepatch_Right");
table.insert(SuburbsDistributions["all"]["inventorymale"].items, 0.5);
table.insert(SuburbsDistributions["all"]["inventorymale"].items, "Base.Antibiotics");
